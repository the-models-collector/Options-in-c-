/* C++ program to calculate the initial price of a strap using the CRR formula */
...
double CRR_formula_Strap(double& S0, double& K, int& T, double& u, double& d, double& r);
...
int main()
{
    ...
    cin >> r;
    cout << "The initial price of a strap is " << CRR_formula_Strap(S0, K, T, u, d, r) << endl;
