/* C++ program to calculate the initial price of a strip using the CRR formula */
...
double CRR_formula_Strip(double& S0, double& K, int& T, double& u, double& d, double& r);
...
int main()
{
    ...
    cin >> r;
    cout << "The initial price of a strip is " << CRR_formula_Strip(S0, K, T, u, d, r) << endl;
